            ...
            <div class="col-sm-9">
                ...
                <form class="order" method="POST" action ="<?= 'admin/php/' . $_GET['page'] . '-update.php' ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <img src="<?= $r->url; ?>" alt="Slider image" class="img-responsive img-panel-slider" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="submit" name="submit" class="edit_item btn btn-lg btn-primary" value="Confirm editing"/>
                    </div>
                </form>
                <?php
