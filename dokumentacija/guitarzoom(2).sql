...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2018 at 01:28 PM
...
(1, 'images/slider-steve.jpg', 'Soloing By Instinct', 'Ignite Your Passion', 'Develop a lifelong passion for guitar and the confidence to express your creativity'),
...
(2, 'username', '14c4b06b824ec593239362517f538b29', 2, '', ''),
(4, 'Dzoni Kejdz', '1dadf5b994f75d7f56173e417955b33f', 2, 'dzoni', 'dzoni@gmail.com'),
(24, 'Dzoni Kejdz', 'e10adc3949ba59abbe56e057f20f883e', 2, 'dzoniopet', 'dzoni@sgmail.com');
...
--
ALTER TABLE `poll`
  MODIFY `id_poll` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
